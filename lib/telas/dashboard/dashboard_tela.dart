...
import '../../backend/models/convidado_modelo.dart'; // IMPORT QUE FALTAVA!
            ...
            children: [
              ...
              SizedBox(width: double.infinity, height: 60, child: ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF6A1B9A), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20))), onPressed: () { 
                if (formKey.currentState!.validate()) { 
                  // CORRIGIDO AQUI: A lista vazia agora é tipada corretamente
                  SatisfactionController.instance.salvarEvento(Evento(id: DateTime.now().toString(), nome: n.text, local: l.text, data: d.text, horario: h.text, convidados: <Convidado>[])); 
